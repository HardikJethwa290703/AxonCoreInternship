...
/*
 * @methods defined the methods to perform CRUD operations on 'student', 'course' and 'enrollment' database table
 * @class use the Logger class for logging the exception
 * @caught handling all the exception in main() method
 */

public class Day17ConsoleAssignment {
	...
	private static final Logger logger = Logger.getLogger(Day17ConsoleAssignment.class.getName());
	...
	public static void main(String[] args) {
		try(Connection con = DriverManager.getConnection(url, username, password)) {
			...
			*/
			...
			// previously printing exception directly
			// e.printStackTrace();
